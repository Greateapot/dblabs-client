...
class Lab3SqlQueries {
  ...
  static Future<void> createDatabase() =>
      ApiRepository.instance.createDatabase(databaseName: databaseName);

  static Future<void> dropDatabase() =>
      ApiRepository.instance.dropDatabase(databaseName: databaseName);

  static Future<void> createTable() => ApiRepository.instance.createTable(
        tableName: tableName,
        options: [
          CreateTableOption(
  ...
  static Future<void> dropTable() =>
      ApiRepository.instance.dropTable(tableName: tableName);

  static Future<Table> getEmployees() => ApiRepository.instance.select(
  ...
  static Future<void> fillTable() => ApiRepository.instance.insert(
        tableName: tableName,
